    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between sm:h-20">
          ...
          <a
            href="#hero"
            className="group relative font-heading text-xl font-bold tracking-tight text-white sm:text-2xl"
          >
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <a
              ...
              className="hidden rounded-full bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/25 sm:block"
            >
              {ctaLabel}
            </a>
