...
export function BioluminescentLetter({
  ...
  return (
    ...
    >
      {/* Subtle ambient glow - very soft, like distant bioluminescence */}
      <span
        aria-hidden="true"
      ...
      {/* Main letter with underwater gradient - like light filtering through water */}
      <span
      ...
      {/* Caustics overlay - animated water light patterns */}
      <span
        aria-hidden="true"
      ...
      {/* Shimmer highlight - like sunlight dancing on water surface */}
      <span
        aria-hidden="true"
      ...
      {/* Soft edge glow - like light diffusing through water */}
      <span
        aria-hidden="true"
        className="absolute inset-0 text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] xl:text-[12rem] font-light tracking-tight select-none"
        style={{
