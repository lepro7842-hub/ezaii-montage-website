# Ezaii — Design Handoff

This folder contains everything needed to implement the Ezaii portfolio website.
...
- `instructions/incremental/` — 7 milestone instructions (foundation, then 6 sections)
...
| # | Milestone | Instruction File | Section ID |
|---|-----------|-----------------|------------|
| 01 | Foundation | `01-foundation.md` | — |
| 02 | Hero | `02-hero.md` | `hero` |
| 03 | Portfolio | `03-portfolio.md` | `portfolio` |
| 04 | Tarifs | `04-tarifs.md` | `tarifs` |
| 05 | Témoignages | `05-temoignages.md` | `temoignages` |
| 06 | Contact | `06-contact.md` | `contact` |
| 07 | Administration | `07-administration.md` | `administration` |
