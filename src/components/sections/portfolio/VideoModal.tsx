      ...
      >
        ...
        <div className="p-6 md:p-8 space-y-6">
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-white leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
              {video.title}
            </h2>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex items-center gap-4 ml-auto">
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-800/80 border border-slate-700/50">
                  ...
                  <span className="text-white font-semibold">{formatNum(video.views)}</span>
                ...
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-800/80 border border-slate-700/50">
                  ...
                  <span className="text-white font-semibold">{formatNum(video.likes)}</span>
          ...
          {video.testimonial && (
            <div className="relative p-6 rounded-2xl bg-gradient-to-br from-slate-800/80 to-slate-800/40 border border-slate-700/50 overflow-hidden">
              <svg className="absolute top-4 left-4 w-12 h-12 text-blue-500/20" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative">
                ...
                <blockquote className="text-slate-300 text-lg leading-relaxed italic">
                  &ldquo;{video.testimonial.text}&rdquo;
                </blockquote>
              </div>
            </div>
          )}
