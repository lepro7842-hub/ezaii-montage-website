...
import type { AdminVideo, AdminTestimonial } from './types'
import { VideoCard } from './VideoCard'
import { AdminTestimonialCard } from './AdminTestimonialCard'
...
export function AdminDashboard({
  ...
  const getLinkedVideo = (videoId: string | null): AdminVideo | undefined => {
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-white font-bold text-lg" style={{ fontFamily: 'var(--font-heading)' }}>
                Ezaii Admin
              </h1>
            </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-white" style={{ fontFamily: 'var(--font-heading)' }}>{videos.length}</p>
          </div>
          <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4">
            <p className="text-slate-400 text-xs uppercase tracking-wider mb-1">Vidéos longues</p>
            <p className="text-2xl font-bold text-blue-400" style={{ fontFamily: 'var(--font-heading)' }}>{longVideos}</p>
          </div>
          <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4">
            <p className="text-slate-400 text-xs uppercase tracking-wider mb-1">Shorts</p>
            <p className="text-2xl font-bold text-rose-400" style={{ fontFamily: 'var(--font-heading)' }}>{shortVideos}</p>
          </div>
          <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4">
            <p className="text-slate-400 text-xs uppercase tracking-wider mb-1">Témoignages</p>
            <p className="text-2xl font-bold text-emerald-400" style={{ fontFamily: 'var(--font-heading)' }}>{testimonials.length}</p>
          </div>
        </div>
